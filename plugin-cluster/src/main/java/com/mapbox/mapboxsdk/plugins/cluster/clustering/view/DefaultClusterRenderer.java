...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
  ...
  public void onAdd() {
    ...
    mClusterManagerPlugin.getMarkerCollection().setOnInfoWindowClickListener(new MapboxMap.OnInfoWindowClickListener() {
      @Override
    ...
    mClusterManagerPlugin.getClusterMarkerCollection().setOnMarkerClickListener(new MapboxMap.OnMarkerClickListener() {
      @Override
      public boolean onMarkerClick(Marker marker) {
    ...
    mClusterManagerPlugin.getClusterMarkerCollection()
      .setOnInfoWindowClickListener(new MapboxMap.OnInfoWindowClickListener() {
        @Override
        public boolean onInfoWindowClick(Marker marker) {
  ...
  public void onRemove() {
    ...
    mClusterManagerPlugin.getMarkerCollection().setOnInfoWindowClickListener(null);
    mClusterManagerPlugin.getClusterMarkerCollection().setOnMarkerClickListener(null);
    mClusterManagerPlugin.getClusterMarkerCollection().setOnInfoWindowClickListener(null);
  }
  ...
  private class MarkerModifier extends Handler implements MessageQueue.IdleHandler {
    ...
    public void animateThenRemove(MarkerWithPosition marker, LatLng from, LatLng to) {
      ...
      animationTask.removeOnAnimationComplete(mClusterManagerPlugin.getMarkerManager());
      ...
      if (!shouldRenderAsCluster(cluster)) {
        for (T item : cluster.getItems()) {
          ...
          if (marker == null) {
            ...
            if (!(item.getTitle() == null) && !(item.getSnippet() == null) && !(item.getIcon() == null)) {
